...
import { faAngleRight, faRightFromBracket, faPhone, faShoppingCart, faUser } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="container mt-2">
                <div className="row">
                    <div className="col-md-12 d-flex">
                        ...
                        <Link to='/SeaFood.jsx' className="text-decoration-none text-dark ">SEA FOOD</Link>
                    </div>
                </div>
            </div>
