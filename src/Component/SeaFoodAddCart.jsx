...
import { faPhone, faRightFromBracket, faStar, faStarHalfStroke, faMinus, faPlus, faShoppingCart, faAngleRight, faUser } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="container bg-white mt-2" id={styles.logo}>
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <form className="d-flex form-group mx-4">
                                <input
                                    type="text"
